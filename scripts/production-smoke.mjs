...
const report = { applicationVersion: '2.0.4', generatedAt: new Date().toISOString(), baseUrl: base, https: base.startsWith('https://'), localHttpException: local && !base.startsWith('https://'), transport: 'HTTP_ONLY', status: results.every((item) => item.pass) ? 'PASS' : 'FAIL', tests: results.length, results };
