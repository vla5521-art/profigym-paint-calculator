...
const report = { applicationVersion: '2.1.1', generatedAt: new Date().toISOString(), results, memoryBeforeBytes: memoryBefore, memoryAfterBytes: process.memoryUsage().heapUsed };
