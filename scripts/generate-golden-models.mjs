...
if (shouldBootstrap) await writeJson(manifestPath, { schemaVersion: '1.0.0', applicationVersion: '2.0.3', generatedBy: 'scripts/generate-golden-models.mjs', fixtures: entries });
