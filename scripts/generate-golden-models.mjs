...
if (shouldBootstrap) await writeJson(manifestPath, { schemaVersion: '1.0.0', applicationVersion: '2.0.1', generatedBy: 'scripts/generate-golden-models.mjs', fixtures: entries });
