...
const report = {
  applicationVersion: '2.0.3', testReportSchemaVersion: '1.2.0', generatedAt: new Date().toISOString(), nodeVersion: process.version, os: os.platform(), architecture: os.arch(), gitCommit: process.env.GITHUB_SHA ?? null,
...
const testReport = `# TEST_REPORT — PROFiGYM 2.0.3
...
Версия: 2.0.3. Итоговый статус: **${stageStatus}**.
