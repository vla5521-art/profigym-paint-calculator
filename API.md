...
# API версии приложения 2.0.3

Форматы импорта не изменились: только `.stp` и `.step`; неподдерживаемые расширения возвращают HTTP 415. Версии приложения и алгоритмов передаются раздельно: `applicationVersion=2.0.3`, geometry `2.0.0`, contact `3.0.0`, feature `4.0.0`.
